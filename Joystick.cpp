	...
	bool includeSteering)
{
	...
	if (buttonCount > 0) {
		...
		buttonValues = new uint8_t[_buttonValuesArraySize];
    oldButtonValues = new uint8_t[_buttonValuesArraySize];
	}
...
void Joystick__::begin(bool initAutoSendState)
{
...
void Joystick__::setButton(uint8_t button, uint8_t value)
{
	if (value == 0)
	{
...
void Joystick__::pressButton(uint8_t button)
{
...
void Joystick__::releaseButton(uint8_t button)
{
    if (button >= _buttonCount) return;
...
void Joystick__::setXAxis(int16_t value)
{
	_xAxis = value;
	if (_autoSendState) sendState();
}
void Joystick__::setYAxis(int16_t value)
{
	_yAxis = value;
	if (_autoSendState) sendState();
}
void Joystick__::setZAxis(int16_t value)
{
	_zAxis = value;
	if (_autoSendState) sendState();
}

void Joystick__::setRxAxis(int16_t value)
{
	_xAxisRotation = value;
	if (_autoSendState) sendState();
}
void Joystick__::setRyAxis(int16_t value)
{
	_yAxisRotation = value;
	if (_autoSendState) sendState();
}
void Joystick__::setRzAxis(int16_t value)
{
	_zAxisRotation = value;
	if (_autoSendState) sendState();
}

void Joystick__::setRudder(int16_t value)
{
	_rudder = value;
	if (_autoSendState) sendState();
}
void Joystick__::setThrottle(int16_t value)
{
	_throttle = value;
	if (_autoSendState) sendState();
}
void Joystick__::setAccelerator(int16_t value)
{
	_accelerator = value;
	if (_autoSendState) sendState();
}
void Joystick__::setBrake(int16_t value)
{
	_brake = value;
	if (_autoSendState) sendState();
}
void Joystick__::setSteering(int16_t value)
{
	_steering = value;
	if (_autoSendState) sendState();
}

void Joystick__::setHatSwitch(int8_t hatSwitchIndex, int16_t value)
{
...
int Joystick__::buildAndSet16BitValue(bool includeValue, int16_t value, int16_t valueMinimum, int16_t valueMaximum, int16_t actualMinimum, int16_t actualMaximum, uint8_t dataLocation[]) 
{
...
int Joystick__::buildAndSetAxisValue(bool includeAxis, int16_t axisValue, int16_t axisMinimum, int16_t axisMaximum, uint8_t dataLocation[]) 
{
...
int Joystick__::buildAndSetSimulationValue(bool includeValue, int16_t value, int16_t valueMinimum, int16_t valueMaximum, uint8_t dataLocation[]) 
{
